...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Bienvenue, {user.firstName}</h1>
        <p className="text-gray-600">Gerez votre compte et consultez vos transactions</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <button className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow text-left">
          ...
          <p className="text-sm text-gray-600">Gerer les cartes bancaires</p>
        </button>
        <button className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow text-left">
          <span className="text-2xl mb-2 block">📊</span>
          <h3 className="font-semibold text-gray-900">Statistiques</h3>
          <p className="text-sm text-gray-600">Analyser les depenses</p>
        </button>
      </div>

      <TransactionList transactions={recentTransactions} title="Transactions recentes" />
    </div>
  );
}
